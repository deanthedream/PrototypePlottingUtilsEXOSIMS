...
plt.xlabel('Planet-star Separation ' + r'$(s)$' + ' in AU', weight='bold')
plt.ylabel('Planet-star Difference in Magnitude', weight='bold')
plt.text(20,48,"{:.2e}".format(comp.count_pop),weight='bold')

#Add Labels
fig.text(0.5, 0.075, 'Planet-star Separation ' + r'$(s)$' + ' in AU', ha='center', weight='bold')
...
#Add Labels
fig2.text(0.5, 0.075, 'Planet-star Separation ' + r'$(s)$' + ' in AU', ha='center', weight='bold')
