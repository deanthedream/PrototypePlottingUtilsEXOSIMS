...
class starkAYO(SurveySimulation):
    ...
    def distributedt(self, sInds, t_dets, sacrificedStarTime, fZ, fEZ, WA):#distributing the sacrificed time
        ...
        dCbydt = self.Completeness.dcomp_dt(t_dets*u.d, self.TargetList, sInds, fZ, fEZ, WA, self.mode, self.Cb, self.Csp)-comp_per_intTime()/Tint#dCbydT[nStars]#Sept 28, 2017 0.12sec
