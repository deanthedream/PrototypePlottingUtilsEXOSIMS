...
dmag = 25. #just a sample number
lhs = 10.**(-0.4*dmag)/(p*Rp**2.)*a**2.*(1.-e)**2.

#DELETE
# def quarticCoefficients_nuFromdmag(e,i,omega,lhs):
...
#     return A, B, C, D
# A, B, C, D = quarticCoefficients_nuFromdmag(e,inc,w,lhs)
