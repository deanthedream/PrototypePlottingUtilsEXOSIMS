...
def dynamicCompleteness(ts2,planetIsVisibleBool2,tobs1,tpast_startTimes):
    """
    ...
    planetNotDetectedBools_times = ~planetDetectedBools_times #for dynamic completeness
    ...
    planetNotDetectedBools2_times = ~planetDetectedBools2_times #for dynamic completeness, the planet is not visible in this time segment at time 2
...
for i in np.arange(len(trange)):
    dynComp, revisitComp = dynamicCompleteness(ts2,planetIsVisibleBool2,tobs1,trange[i])
