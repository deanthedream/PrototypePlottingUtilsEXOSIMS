...
cbar.set_label(r'Zodiacal Light Intensity, $fZ(l,b)$', weight='bold')
  

plt.xlabel('Heliocentric Earth Ecliptic Longitude, ' + r'$l$' + '\n' + r'$\ |ra_{i/SC} - ra_{SC/\odot}|$ ($^\circ$)', weight='bold')
plt.ylabel('Heliocentric Earth Ecliptic Latitude, ' + r'$b$' + '\n' + r'$\ |dec_{i/SC} - dec_{SC/\odot}|$ ($^\circ$)', weight='bold')
plt.xlim(0,180)
plt.ylim(0,90)
